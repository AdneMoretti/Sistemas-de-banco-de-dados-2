...
--
-- Atualizado: 10/11/2020 - incluiu novas tuplas para
--                          destacar as funcionalidades
--                          da programacao exigida.
-- ------------------------------------------------------
...
-- Popula PESSOA
--
INSERT INTO `pessoa` (`idPessoa`,`nome`,`dataNascimento`,`sexo`) VALUES
 (1,'Levino Andrade','1992-02-18','M'),
 (2,'Ana Maria Silva','1994-10-10','F'),
 (3,'Luis Carvalho','2010-01-08','M'),
 (4,'Regis Carvalho','2001-12-27','M');
...
-- Popula ENDERECO
--
INSERT INTO `endereco` (`idEndereco`,`rua`,`numero`,`bairro`,`complemento`,`idPessoa`) VALUES
...
-- Popula TELEFONE
--
INSERT INTO `telefone` (`id`,`telefone`,`idPessoa`) VALUES
 (1,98181818,1),
 (2,34323232,2),
 (3,91415665,3),
 (4,34561278,2);
